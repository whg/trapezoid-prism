...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 191.0, 381.0, 141.0, 22.0 ],
					"style" : "",
					"text" : "mexican 49 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 392.0, 558.0, 110.0, 22.0 ],
					"style" : "",
					"text" : "prepend midimode"
				}
...
, 			{
				"box" : 				{
					"id" : "obj-36",
					"items" : [ "single", ",", "zline", ",", "travel" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 351.5, 516.0, 100.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 17.0, 531.0, 67.0, 22.0 ],
					"style" : "",
					"text" : "note 2 100"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 820.0, 707.0, 69.0, 22.0 ],
					"style" : "",
					"text" : "colorpicker"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 239.0, 747.0, 52.0, 35.0 ],
					"style" : "",
					"text" : "note 49 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 338.0, 610.0, 30.0, 22.0 ],
					"style" : "",
					"text" : "t b l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 338.0, 681.0, 81.0, 22.0 ],
					"style" : "",
					"text" : "prepend note"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 17.0, 566.0, 67.0, 22.0 ],
					"style" : "",
					"text" : "note 2 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 267.0, 630.0, 50.0, 35.0 ],
					"style" : "",
					"text" : "mexican"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 298.0, 561.0, 57.0, 22.0 ],
					"style" : "",
					"text" : "zl.slice 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 316.0, 737.0, 100.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 338.0, 643.0, 141.0, 22.0 ],
					"style" : "",
					"text" : "49 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 255.0, 460.0, 119.0, 22.0 ],
					"style" : "",
					"text" : "route /vol /MIDI/note"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 114.0, 523.0, 160.0, 22.0 ],
					"style" : "",
					"text" : "bing 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 481.0, 444.0, 549.0, 62.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 701.0, 20.0, 540.0, 325.0 ]
				}
